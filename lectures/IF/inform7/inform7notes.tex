...
The description is "It looks like it's made for a bird."
\ed
\end{frame}
...
\bframe{Scenery that needs to be examined}
\bd
\ii The Forest is a room.  "You stand in a clearing in the deep jungle. Obscured by centuries of overgrowth and dim sunlight is a ruined temple of some sort. Whatever details there may have been on the stone blocks have long since been worn away. [if we have examined the temple]There is a single, solitary entryway leading downward[end if]."\sk
\ii The temple is here. It is scenery. The description is "The stone blocks lie tumbled about, as if they were strewn about. Vines cover the upper half, while soil, leaves and grasses cover the bottom half. A set of steep stairs goes straight down into darkness."
\ed
\end{frame}
...
\centerline{\includegraphics[width=2.25in]{actionschart.png}}
