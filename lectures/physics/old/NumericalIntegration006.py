...
def newSystem(n):
    ...
    velocities = N.random.random(3*n)*4.0 - 2.0
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if event.key == K_ESCAPE:
                    ...
                    mysystem = reset(nParticles)
                    mytext = ['gravity(2000.0)']
                elif event.key == K_F4:
                    mysystem = reset(nParticles)
                    mytext = ['gravity(200.0)','drag(0.1)']
                elif event.key == K_F5:
                    mysystem = reset(nParticles)
                    mytext = ['gravity(200.0)', 'spring(0.2)']
                elif event.key == K_F6:
                    mysystem = reset(nParticles)
                    mytext = ['gravity(200.0)','spring(0.2)','drag(0.05)']
                elif event.key == K_F7:
                    mysystem = reset(nParticles)
                    mytext = ['spring(0.5)']
                elif event.key == K_F8:
                    ...
                    mysystem = reset(nParticles)
                    mytext = ['springpairs(0.1)', 'gravity(300.0)']
                elif event.key == K_1:
                    mystepper = EulerStep
                    stepperfactor = 4
